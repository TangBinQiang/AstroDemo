import { A as AstroError, L as LiveContentConfigError, v as AstroUserError, z, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, w as escape, x as renderUniqueStylesheet, y as renderScriptElement, B as createHeadAndContent, r as renderComponent } from './astro/server_DbTCsXAD.mjs';
import { r as removeBase, i as isRemotePath, V as VALID_INPUT_FORMATS, p as prependForwardSlash } from './consts_DF5Kf-cg.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_C8o1NGTk.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://astro-paper.pages.dev/", "SSR": true};
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_BPmle9Hi.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_DNqdwIJt.mjs').then(n => n._);
...
export { CONTENT_LAYER_TYPE as C, LIVE_CONTENT_TYPE as L, defineCollection as d, getCollection as g, pLimit as p, renderEntry as r };
